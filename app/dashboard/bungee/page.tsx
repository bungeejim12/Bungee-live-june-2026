        ...
        if (user) {
          ...
          if (profileData) {
            ...
            setProfile({
              ...
              user_type: user.user_metadata?.user_type || 'bungee',
              is_demo: false,
              tax_verified: false,
            })
            setIsDemo(false)
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex">
        ...
        `}>
          <div className="p-4">
            ...
            <nav className="mt-6 space-y-1">
              <a href="#" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-900 bg-emerald-50 border border-emerald-200">
        ...
        {/* Main Content - Referral Dashboard */}
